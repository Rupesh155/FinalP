...
//         try{
//             await axios.post('http://localhost:1000/send-otp',{phoneNumber:formData})
...
//                         <input onChange={(e)=>{SetFormData(e.target.value)}}  type='tel' className='
//                          text-[#555555ba] w-[200px] border-0 border-b border-[#555] rounded-none ml-[-20px]' placeholder='e:g  +91 8080808080......' />
//                     </div>
//                     <div className='mt-12'>
...
import { MdOutlineMailOutline } from "react-icons/md";
import { FaApple } from "react-icons/fa6";
import { FcGoogle, FcCallback } from "react-icons/fc";
import { RxCross2 } from "react-icons/rx";
import { IoIosNotificationsOutline } from "react-icons/io";
import { CiLock } from "react-icons/ci";
import { FaShoppingCart } from "react-icons/fa";
...
const NavBar = () => {
  ...
  const sendOtp = async () => {
    try {
     let res=    await axios.post("http://localhost:8000/send-otp", { phoneNumber });
  ...
  return (
    <div className="relative overflow-hidden">
      {/* Login/SignUp Modal */}
      <div
        className="bg-[#55555591] h-full w-full fixed z-10"
        ...
        <div className="w-[420px] h-[550px] p-5 bg-white fixed left-[35%] translate-y-28 rounded flex flex-col items-center">
          ...
          {!otpSent ? (
            <>
              ...
              <div className="mt-12">
                <button onClick={sendOtp} className="w-[300px] bg-red-500 text-white p-2 rounded">
                  Send OTP
                </button>
              </div>
            </>
            ...
            <>
              ...
              <div className="mt-12">
                <button
                  onClick={verifyOtp}
                  className="w-[300px] bg-green-500 text-white p-2 rounded"
                >
                  Verify OTP
                </button>
              </div>
