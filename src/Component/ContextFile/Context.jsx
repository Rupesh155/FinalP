...
// // const axios = require('axios'); // Import axios if not already
...
// // let data={
// //     apiData: async function(){
// //         try{
// //               let res= await axios.get('http://localhost:1000/movies')
...
// // console.log(data.apiData(),"apiiiiii");
...
// //     useEffect(() => {
// //         // Fetch Movie Data
// //         // fetch('/api/movies') // Replace '/api/movies' with your movie API endpoint
...
// //         // Fetch Games Data
// //         fetch('http://locahost:8000/movies') // Replace '/api/games' with your games API endpoint
// //             .then((response) => response.json())
// //             .then((data) => {
...
// //     return (
// //         <Context.Provider value={{  gamesData }}>
// //             {children}
// //         </Context.Provider>
// //     );
// // }
...
function ContextProvider({ children }) {
    ...
    useEffect(() => {
        const fetchMovies = async () => {
            try {
                const response = await axios.get('http://localhost:8000/movies');
                setMovieData(response.data); // Fetched data store karna
                setLoading(false); // Loader stop karna
            } catch (error) {
                console.error('Error fetching data:', error);
                setLoading(false); // Error ke case me bhi loader stop karna
            }
        };
